...
class newBingCrawler:
    ...
    def __call__(self):
        ...
        async def main(loop):
            ...
            chrome_path = "D:\PycharmProjects\selenium_driver_chrome\chromedriver.exe"
            ...
            for link in Links:
                linkstr = str(link)
                if (('http' in linkstr) and ('href' in linkstr) and (not 'href="#"' in linkstr) and (
                not 'href="http://go.microsoft' in linkstr) and (not 'microsofttranslator' in linkstr)):
